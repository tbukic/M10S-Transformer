...
# Need to import obsolete module for KrotQ + tieQKnorm build
...
_CHECKPOINT = _PROJECT_ROOT / "checkpoints" / "qwen3_arc_41p_KrotQ_s36_targeted" / "best.pt"

METADATA = {
    "name": "M10S-41p",
    "author": "Tom Bukic",
    "params": 41,
    "architecture": "1L decoder-only transformer + circular arc embed, d=3, 1h/1kv, hd=4, ff=2, K=rot(Q), V=Q, tieQO, shnorm, tieQKnorm",
    "tricks": [
        ...
        "Targeted fine-tuning (3 iterations, 114 cumulative error pairs)",
    ],
}
...
def build_model():
    ...
    cfg_name = "41p_ff2_tieQO_KrotQ_shnorm_VeqQ_tieQKnorm"
