...
Staghado independently converged on the same 122-parameter Qwen3
architecture (d=3, 1h, hd=4, ff=3, RoPE $\theta$=3), reaching 99.95\%
accuracy. Their L-BFGS fine-tuning insight---that AdamW converges to
saddle points which second-order methods can escape---directly inspired
our L-BFGS experiments (Section~\ref{sec:lbfgs}).
